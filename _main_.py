...
from Otan.Core.PyTgCalls.Otan import (pytgcalls1, pytgcalls2, pytgcalls3,
...
from Otan.Inline import private_panel
from Otan.Plugins import ALL_MODULES
from Otan.Utilities.inline import paginate_modules
...
async def initiate_bot():
    with console.status(
        ...
        for all_module in ALL_MODULES:
            imported_module = importlib.import_module(f"Otan.Plugins.{all_module}")
            if (
    ...
    if STRING1 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_1.join_chat("gabutnyakenshin")
            await ASS_CLI_1.join_chat("OtanJungle")
        except:
            pass
    ...
    if STRING2 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_2.join_chat("gabutnyakenshin")
            await ASS_CLI_2.join_chat("OtanJungle")
        except:
            pass
    ...
    if STRING3 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_3.join_chat("gabutnyakenshin")
            await ASS_CLI_3.join_chat("OtanJungle")
        except:
            pass
    ...
    if STRING4 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_4.join_chat("gabutnyakenshin")
            await ASS_CLI_4.join_chat("OtanJungle")
        except:
            pass
    ...
    if STRING5 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_5.join_chat("gabutnyakenshin")
            await ASS_CLI_5.join_chat("OtanJungle")
        except:
            pass
    ...
    if LOG_SESSION != "None":
        try:
            ...
            return
        try:
            await LOG_CLIENT.join_chat("gabutnyakenshin")
            await LOG_CLIENT.join_chat("OtanJungle")
        except:
            pass
    console.print("└[red] Otan Music Bot Completed.")
    if STRING1 != "None":
